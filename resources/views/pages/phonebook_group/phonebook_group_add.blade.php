...
@section('content')
	<div class="row">
		<div class="col-md-12" style="min-height:600px;">
			<div class="box">
				<div class="box-title">
					<h3><i class="fa fa-bars"></i> Phonebook Group Add Form</h3>
				...
				<div class="box-content" style="min-height:50px; padding:50px 5px;">
					<form action="{{ route('phonebook_group_store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
						@csrf
						...
						<div class="form-group">
							<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
								<button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Add Group </button>
