		...
		<div class="col-md-12" style="min-height:600px;">
			<div class="box">
				...
				<div class="box-content" style="min-height:500px;max-width:768px; margin: 0 auto; padding:50px 5px;">
					<form action="{{ route('get_group_number') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
						@csrf
						<div class="form-group">
							<label class="col-sm-3 col-lg-2 control-label"> Group List </label>
						...
						<div class="form-group">
							<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
								<button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Get Numbers </button>
							</div>
						</div>
					</form>
					...
					@isset($numbers)
							<form action="{{ route('send_sms') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-9 col-lg-10 controls">
										<textarea id="phone_number" name="phone_number" rows="8" class="form-control" pattern="(^[8801]{4}[3-9]{1}[0-9]{8}|,)$">@php
										foreach ($numbers as $number) {
											echo '88'.$number->phone_number.',';
										}
										@endphp</textarea>
