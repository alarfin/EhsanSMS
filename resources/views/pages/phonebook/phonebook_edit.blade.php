...
@section('content')
	<div class="row">
		<div class="col-md-12" style="min-height:600px;">
			<div class="box">
				<div class="box-title">
					<h3><i class="fa fa-bars"></i> Edit Phonebook</h3>
				...
				<div class="box-content" style="min-height:50px; padding:50px 5px;">
					<form action="{{ route('phonebook_update', $phonebook->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
						@csrf
						<div class="form-group">
							<label class="col-sm-3 col-lg-2 control-label">Name </label>
							<div class="col-sm-9 col-lg-10 controls">
								<input type="text" id="name" name="name" placeholder="Enter name" pattern="([a-zA-Z]{3,30}\s*)+" value="{{ $phonebook->name??'' }}" class="form-control" />
						...
						<div class="form-group">
							...
							<div class="col-sm-9 col-lg-10 controls">
								<input type="text" id="phone_number" name="phone_number" placeholder="Enter Phone Number" pattern="(^[01]{2}[3-9]{1}[0-9]{8})$" value="{{ $phonebook->phone_number??'' }}" class="form-control" />
								{{-- <span id="name_msg" class="help-inline" style="color:red"></span> --}}
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9 col-lg-10 controls">
								<select class="form-control" name="group_id">
									<option value="{{ $phonebook->group_id }}">{{ $phonebook->group->name }}</option>
